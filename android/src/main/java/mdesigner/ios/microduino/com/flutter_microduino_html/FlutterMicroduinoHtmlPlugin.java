...
/** FlutterMicroduinoHtmlPlugin */
public class FlutterMicroduinoHtmlPlugin implements MethodCallHandler, PluginRegistry.ActivityResultListener  {
  /** Plugin registration. */
    ...
    private static final String CHANNEL_NAME = "flutter_microduino_html";
  
   public static void registerWith(PluginRegistry.Registrar registrar) {
        channel = new MethodChannel(registrar.messenger(), CHANNEL_NAME);
        final FlutterMicroduinoHtmlPlugin instance = new FlutterMicroduinoHtmlPlugin(registrar.activity());
        registrar.addActivityResultListener(instance);
        channel.setMethodCallHandler(instance);
    }

    private FlutterMicroduinoHtmlPlugin(Activity activity) {
